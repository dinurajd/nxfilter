...
//-----------------------------------------------
String param_str(String key, String default_value){
	return param.get_str(key, default_value);
}
...
boolean check_permission(){
	...
	if(is_slave() && request.getRequestURI().indexOf("config,cluster.jsp") == -1){
		try{
			response.sendRedirect("config,cluster.jsp");
		}
		catch(Exception e){}
		return false;
	}
