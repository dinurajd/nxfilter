...
function go_edit(id){
	var form = document.go_form;
	form.action = "user,ldap_edit.jsp";
	form.id.value = id;
	form.submit();
}
...
//-----------------------------------------------
function action_import_ldap(id){
	var form = document.go_form;
	form.action = "<%= get_page_name()%>";
...
<table width="100%" cellpadding="4" class="view">
	...
	<tr>
		<td>Admin</td>
		<td>
			<input type="text" name="admin" size="25"> ex) cn=admin,dc=nxfilter,dc=local
		</td>
	</tr>
	...
	<tr>
		<td>Base DN</td>
		<td>
			<input type="text" name="basedn" size="40"> ex) dc=nxfilter,dc=local
		</td>
	</tr>
...
%>
	<tr height="24">
		...
		<td align="right">
		<input type="button" value="IMPORT" onclick="javascript:action_import_ldap(<%= data.id%>)">
